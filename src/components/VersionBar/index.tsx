  ...
  return (
    <Wrapper>
      ...
      <ButtonMenu variant="primary" scale="sm" activeIndex={0}>
        <ButtonMenuItem as="a" href="https://exchange.pixiuswap.finance/">
          V2
        </ButtonMenuItem>
        <ButtonMenuItem as="a" href="https://v1exchange.pixiuswap.finance/#/">
          V1 (old)
        </ButtonMenuItem>
      </ButtonMenu>
      <Button
        variant="subtle"
        as={Link}
        href="https://v1exchange.pixiuswap.finance/#/migrate"
