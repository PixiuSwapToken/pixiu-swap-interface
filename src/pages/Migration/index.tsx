        ...
        <Wrapper>
          ...
          <Card mb="32px">
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://exchange.pixiuswap.finance/#/pool" style={{ width: '100%' }}>
                Add liquidity
              </Button>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://pixiuswap.finance/farms" style={{ width: '100%' }}>
                Go to farms
              </Button>
            </CardBody>
          </Card>
